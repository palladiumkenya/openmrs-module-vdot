 ...
 */
public class IntegerToNimeconfirmEnrolmentConverter {
    @Component
    public class IntegerToNimeconfirmVideoObsConverter implements Converter<Integer, NimeconfirmEnrolment> {
